...
const SwapResidenceInfo = ({overture, residence, ...props}) => {
    ...
    residence?.amenities?.slice(0, 4).map(amenity => (
      <React.Fragment>
        <Stack direction="row" alignItems="baseline" justifyContent="center" spacing={1}>
          <Typography sx={{ font: '20px VT323', color: '#696969', textShadow: '2px 3px 6px rgba(0,0,0,0.3)' }}>
            •
          </Typography>
          <Typography sx={{ font: '20px VT323', color: '#CC0000', textShadow: '2px 3px 6px rgba(0,0,0,0.3)' }}>
            {amenity}
          </Typography>
        </Stack>
      </React.Fragment>
  ...
  const cardTitle = (
    <Stack direction="column" alignItems="center" justifyContent="space-evenly" sx={{ mt: -2, mb: -2.25 }}>
      ...
      <Typography sx={{ font: '32px VT323', color: '#696969', textShadow: '2px 3px 3px rgba(0,0,0,0.3)' }}>
        {residence?.name}
      </Typography>
    </Stack>
  );
  ...
  return (
    <Card sx={{ width: "100%", background: "none", border: "none", boxShadow: "none" }}>
      <CardHeader
        title={cardTitle}
      />
      <CardContent>
        ...
        <Stack direction="column" alignItems="center" justifyContent="space-evenly" spacing={1} sx={{ mt: 1, mb: 2 }}>
          ...
          {overture === "ask" ?
            <Typography align='center' sx={{ font: '32px VT323', color: '#696969', textShadow: '2px 3px 3px rgba(0,0,0,0.3)' }}>
              {redact(address)}
            </Typography>
          :
            <Typography align='center' sx={{ font: '32px VT323', color: '#696969', textShadow: '2px 3px 3px rgba(0,0,0,0.3)' }}>
        ...
        <Typography align="center" sx={{ font: '40px VT323', fontWeight: 'bold', color: '#CC0000', textShadow: '2px 3px 4px rgba(0,0,0,0.3)', mt: 1 }}>
         ...
         <Stack direction="row" alignItems="baseline" justifyContent="space-around" divider={<Divider orientation="vertical" flexItem />} spacing={1} sx={{ mt: 2.5, mb: 2 }}>
          <Stack direction="column" alignItems="center" justifyContent="center" spacing={1}>
            <Typography sx={{ font: '22px VT323', color: '#696969', textShadow: '2px 2px 3px rgba(0,0,0,0.3)' }}>
              Neighborhood:
            </Typography>
        ...
        <Stack direction="row" alignItems="baseline" justifyContent="space-evenly" divider={<Divider orientation="vertical" flexItem />} spacing={1} sx={{ mb: 2 }}>
      ...
      <CardActions disableSpacing>
        { !expanded ?
          <Button
            variant="contained"
            size="small"
            endIcon={<KeyboardArrowUpIcon sx={{ color: "#FFFFFF", height: 25, width: 25 }} />}
        ...
        :
          <Button
            variant="contained"
            size="small"
            endIcon={<KeyboardArrowDownIcon sx={{ color: "#FFFFFF", height: 25, width: 25 }} />}
            onClick={handleExpandClick}
            sx={{  
              font: '26px VT323',
              fontWeight: 'bold',
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography paragraph sx={{ font: '22px VT323', color: '#696969', textShadow: '2px 3px 6px rgba(0,0,0,0.3)', mt: 1.5 }}>
...
export default SwapResidenceInfo;

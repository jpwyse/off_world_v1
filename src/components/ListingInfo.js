...
const ListingInfo = ({listing, residence, ...props}) => {
      ...
      <CardActions disableSpacing>
        { !expanded ?
          <Button
            variant="contained"
            size="small"
            endIcon={<KeyboardArrowUpIcon sx={{ color: btnHover ? "#FFFFFF" : "#CC0000", height: 25, width: 25 }} />}
        ...
        :
          <Button
            variant="contained"
            size="small"
            endIcon={<KeyboardArrowDownIcon sx={{ color: btnHover ? "#FFFFFF" : "#CC0000", height: 25, width: 25 }} />}
            onMouseOver={() => setBtnHover(true)}
            onMouseLeave={() => setBtnHover(false)}
            onClick={handleExpandClick}
            sx={{  
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        ...
        <CardActions>
          <Button
            ...
            onClick={() => props.handleSwapClick(listing)}
            sx={{  
              font: '26px VT323',
              fontWeight: 'bold',
              color: '#FFFFFF',
